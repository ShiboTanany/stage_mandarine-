...
*/
package com.ntgclarity.mandarine.constants;

public interface CodesAndMessages {

	public static final String NO_ERRORS_CODE = "000";
	public static final String NO_ERRORS_MESSAGE = "No Errors";

	public static final String INTERNAL_SERVER_ERROR_MESSAGE = "INTERNAL_SERVER_ERROR_MESSAGE";
	public static final String INTERNAL_SERVER_ERROR_CODE = "INTERNAL_SERVER_ERROR_CODE";
	
	public static final String SUBSCRIBER_NUMBER_ERROR_CODE = "999";
	public static final String SUBSCRIBER_NUMBER_ERROR_MESSAGE = "System_Not_Available_Please_Contact_NTG_Clarity_Administrator";
